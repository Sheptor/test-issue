...
BC = {'PEC' 'PML_8' 'PEC' 'PML_8' 'PML_8' 'PML_8'}; % boundary conditions
...
plot(freq*1e-6,20*log10(abs(s11)),'r-','Linewidth',2);
xlim([freq(1) freq(end)]*1e-6);
grid on;
hold on;
plot(freq*1e-6,20*log10(abs(s21)),'g--','Linewidth',2);
plot(freq*1e-6,20*log10(abs(s31)),'b--','Linewidth',2);
plot(freq*1e-6,20*log10(abs(s41)),'y--','Linewidth',2);
...
%% plot s-parameter %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
hf = figure('visible','off');
plot(freq*1e-6,abs(s11).^2,'r-','Linewidth',2);
xlim([freq(1) freq(end)]*1e-6);
grid on;
hold on;
plot(freq*1e-6,abs(s21).^2,'g--','Linewidth',2);
plot(freq*1e-6,abs(s31).^2,'b-','Linewidth',2);
plot(freq*1e-6,abs(s41).^2,'y-','Linewidth',2);
l = legend('S_{11}^{2}','S_{21}^{2}','S_{31}^{2}','S_{41}^{2}','Location','northeast');
set(l,'FontSize',8);
